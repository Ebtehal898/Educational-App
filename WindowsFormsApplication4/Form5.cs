    ...
    public partial class Form5 : Form
    {
      ...
      public static int wrongans = 1;
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
          ...
          //  frm1.BackgroundImage = Image.FromFile(Application.StartupPath + @"\image\fo.png");
               

            //pos = randomClass3.Next(0, 1);
            //pos1 = randomClass2.Next(2, 3);
            //pos2 = randomClass1.Next(4, 5);
            //pos = randomClass.Next(6, 7);
            // pos4 = randomClass4.Next(8, 9);
            // if (radioButton5.Checked == true)
            //{
            /* pos = randomClass.Next(0, 9);
             pictureBox2.Image = imeges[pos];
             pictureBox3.Image = imeges[pos];
             pictureBox4.Image = imeges[pos];
             pictureBox5.Image = imeges[pos];
             pictureBox6.Image = imeges[pos];*/
           ...
           /* if (pictureBox2.Image == null && pictureBox3.Image == null && pictureBox4.Image == null && pictureBox5.Image == null && pictureBox6.Image == null)
            {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            // if (timer1.Interval == 0)
            {
                ...
                MessageBox.Show("أنتهى الوقت ", "أنتهى الوقت");
            }
        }
        ...
        private void radioButton5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            pos = randomClass.Next(0, 9);
            // if(pos1 == pos2 || pos1 == pos3 || pos1 == pos4 || pos1 == pos||pos2==pos3 ||pos4==pos3||pos4)
            for (int i = 0; i < 5; i++)
            {
                if (pos1 != pos && pos1 != pos3 && pos1 != pos4 && pos1 != pos2)
                {

                    pictureBox2.Image = imeges[pos1];
                }
                ...
                if (pos2 != pos1 && pos2 != pos3 && pos2 != pos4 && pos2 != pos)
                {
                ...
                if (pos3 != pos1 && pos3 != pos2 && pos3 != pos4 && pos3 != pos)
                {
                ...
                if (pos4 != pos1 && pos4 != pos2 && pos4 != pos3 && pos4 != pos)
                {
            ...
            if (pictureBox9.Image == pictureBox9 . Image || pictureBox9.Image == pictureBox3.Image || pictureBox9.Image == pictureBox4.Image
            ...
            /* for(int i = 0; i < 5; i++)
             {
               ...
               pictureBox3.Image = imeges[pos];
               pos2 = randomClass.Next(0, 9);
               pictureBox4.Image = imeges[pos2];
               if (pos == pos2)
               {
                   pos2 = randomClass.Next(0, 9);
               }
             /*pictureBox2.Image = imeges[pos];
             pictureBox3.Image = imeges[pos1];
             pictureBox4.Image = imeges[pos2];
             pictureBox5.Image = imeges[pos3];
             pictureBox6.Image = imeges[pos4];
             String name = pictureBox2.Text;
             //PictureBox ran = new PictureBox();
             if (pictureBox7.Image == pictureBox2.Image)
             {
                 pictureBox7.Image = null;
             }
             ...
             if (pictureBox9.Image == pictureBox3.Image)
             {
                 pictureBox9.Image = null;
             }
             else if (pictureBox10.Image == pictureBox3.Image)
             {
                 pictureBox10.Image = null;
             }
             if (pictureBox11.Image == pictureBox4.Image)
             {
                 pictureBox11.Image = null;
             }
             else if (pictureBox12.Image == pictureBox4.Image)
             {
                 pictureBox12.Image = null;
             }
             if (pictureBox13.Image == pictureBox5.Image)
             {
                 pictureBox13.Image = null;
             }
             else if (pictureBox14.Image == pictureBox5.Image)
             {
                 pictureBox14.Image = null;
             }
             if (pictureBox15.Image == pictureBox6.Image)
             {
                 pictureBox15.Image = null;
             }
             else if (pictureBox16.Image == pictureBox6.Image)
             {
                 pictureBox16.Image = null;
             }*/
